...
//        Drink drink = drinkService.addDrink(DrinkDto.fromDrink());
//        return new ResponseEntity<>(DrinkDto.fromDrink(drink), HttpStatus.OK);
//    }
//
//    @GetMapping
//    public ResponseEntity<List<DrinkDto>> getDrinks(){
//        List<Drink> drinks = drinkService.getDrinks();
//        List<DrinkDto> drinksDto = drinks.stream().map(DrinkDto::fromDrink).collect(Collectors.toList());
...
//        return new ResponseEntity<>(DrinkDto.fromDrink(editedDrink), HttpStatus.OK);
//    }
