...
public class OrderController {
    ...
    public ResponseEntity<OrderDto> addDrinkToOrder(@PathVariable final Long orderId,
                                                    @PathVariable final Long drinkId){
        Order order = orderService.addDrinkToOrder(orderId, drinkId);
        return new ResponseEntity<>(OrderDto.from(order), HttpStatus.OK);
    }
    ...
    public ResponseEntity<OrderDto> removeDrinkFromOrder(@PathVariable final Long orderId,
                                                    @PathVariable final Long drinkId){
        Order order = orderService.removeDrinkFromOrder(orderId, drinkId);
        return new ResponseEntity<>(OrderDto.from(order), HttpStatus.OK);
    }
}
